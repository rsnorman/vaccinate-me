...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post interactions_url, params: { interaction: { interaction_type_id: @interaction.interaction_type_id } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { interaction_type_id: @interaction.interaction_type_id } }
